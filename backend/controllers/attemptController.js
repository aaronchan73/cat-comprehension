...
const generateFeedback = async (attempt) => {
    ...
    const ollamaGenerateUrl = 'http://host.docker.internal:11434/api/generate';
    const feedbackPrompt = `Based on this code that was generated by an LLM: ${code}, can you explain what can be improved given the following test cases: ${testResults}?`
